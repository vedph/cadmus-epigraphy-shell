...
@NgModule({ declarations: [EpiSupportPartComponent, EpiSupportPartFeatureComponent],
    exports: [EpiSupportPartComponent, EpiSupportPartFeatureComponent], imports: [CommonModule,
        FormsModule,
        ReactiveFormsModule,
        RouterModule,
        // material
